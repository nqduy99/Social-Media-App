    ...
    return (
      <>
        <div className="birthdayContainer">
          ...
          <span className="birthdayText"><b>Vo Ngoc Tran</b> and <b>3 other friends</b> have a birthday today</span>
        </div>
      ...
      <>
        ...
        <div className="rightbarFollowings">
          <div className="rightbarFollowing">
            <img className="rightbarFollowingImg" src="assets/person/baukrysie_02.jpg" alt="" />
